...
export type Query = {
  ...
  getListingDraft?: Maybe<Array<Maybe<Listing>>>;
};
...
export type ListingPaginationResolvers<ContextType = any, ParentType extends ResolversParentTypes['ListingPagination'] = ResolversParentTypes['ListingPagination']> = ResolversObject<{
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getListingDraft?: Resolver<Maybe<Array<Maybe<ResolversTypes['Listing']>>>, ParentType, ContextType>;
}>;
